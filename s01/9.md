...
- funkcionális és nem funcionális tulajdonságok tesztelésére, illetve strukturális tesztelésre is használatos
...
- a tesztelés inkább folyamán, mint egyszeri tevékenység
...
Az elvárt kimenetet az orákulum segítségével tudjuk kiszámolni. Az orákulum megmondja, hogy mi az elvárt kimenete
...
- a használati eset diagram a rendszer egy adott szerepló általi használatának leírása
...
**Műszaki tesztterv specifikáció:** Tesztelési  feltételeket és a követelmények,  
...
**Tesztelem kiadás jelentés:** Kiadott tesztelemek, kiadás dátumát és ki engedélyezte.

**Tesztincidens jelentés**

## 9. Teszteszközök. <a name="chapter09"></a>
### Tesztelést és tesztirányítást támogató eszközök
...
Olyan eszköz mely támogatja a követelményeknek, a követelmény jellemzőinek (pl. prioritás, tudásgazda) rögzítését
és magyarázó jegyzetek készítését.
...
### Statikus tesztelést segítő  eszközök
...
### Tesztspecifikálást támogató eszközök
...
### Tesztvégrehajtás és naplózás támogató eszközök
...
### Teljesítményt és monitorozást támogató eszközök
