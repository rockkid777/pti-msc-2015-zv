...
* Egyszerű szervezet
    ...
    ![Egyszerű szervezet](img/egyszeru_szervezet.png){ width=350 }
...
* Funkcionális szervezet
    ...
    ![Funkcionális szervezet](img/funkcionalis_szervezet.png){ width=350 }
...
* Projekt csapat
    ...
    ![Projekt csapat](img/projekt_csapat.png){ width=350 }
...
![Példa közepes projekt felépítésre 1](img/kozepes_projekt1.png){ width=400 }

![Példa közepes projekt felépítésre 2](img/kozepes_projekt2.png){ width=400 }
...
![A nagy projekt szervezet](img/nagy_projekt.png){ width=500 }
...
![A felelősségek hozzárendelése OBS és WBS alapján](img/OBS_WBS.png){ width=450 }

A felelősségek ábrázolásának egy hatékony eszköze a RACI (Responsible, Accountable, Consulted, Informed) mátrix.

![RACI mátrix](img/RACI.png){ width=350 }
...
![Tevékenység ábrázolása](img/idoterv_tevekenyseg.png){ width=350 }

![Időterv kiindulás](img/idoterv1.png){ width=350 }
...
![Időterv kiindulás](img/idoterv2.png){ width=350 }
...
![Időterv kiindulás](img/idoterv3.png){ width=350 }

A kritikus útat azok a tevékenységek határozzák meg, melyek teljes időjátéka nulla.

![Időterv kiindulás](img/idoterv4.png){ width=350 }
...
![Kritikus lánc módszer példa](img/kritikus_lanc.png){ width=350 }
...
![Kockázati mátrix](img/risk_matrix.png){ width=350 }
...
![Nemezeti kultúra példa](img/nemzeti_kultura.png){ width=350 }
...
![Kapcsolat az érdekcsoportok és a projekt között](img/eredekcsoport_kapcsolatok.png){ width=350 }
...
![A kapcsolat hőfoka](img/ugyfelkapcsolat_hofoka.png){ width=450 }
...
![Vezetési szerepek](img/vezetesi_szerepek.png){ width=350 }
...
![Frederick Herzberg piramisa](img/fredeick_herzberg.png){ width=350 }
