...
* _def. 1_: A projekt a kitűzött CÉL érdekében kölcsönösen egymásra ható tevékenységek csoportja, mely megába foglal
...
A informatikai projektek első, és legfontosabb jellemzője, hogy **önmagában nincs informatikai projekt**.
...
![Egyszerű szervezet](img/eszeru_szervezet.png)
...
![Funkcionális szervezet](funkcionalis_szervezet.png)
...
![Projekt csapat](projekt_csapat.png)
...
![Vállalatok életciklusai](vallalatok_eletciklusai.png)
