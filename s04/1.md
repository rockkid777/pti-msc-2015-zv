S4/1. Párhuzamos folyamatok modellezése Petri hálók segítségével. Petri hálók definíciója és működési szabálya. 
...
1. t aktivizálható, ha $\forall$p $\in$ $\bullet$t: M(p) $\ge$ v(p, t).
...
$\Sigma$ = (S, T, W, $\lambda$, M), ahol S a helyek, T az átmenetek halmaza, W az éleket leíró reláció, $\lambda$ a
 címkefüggvény, M pedig a súlyozás.
...
## Párhuzamos és elosztott rendszerek szemantikai leírása lehetséges formái
