...
**Természetes levezetés**
  ...
  * **Természetes technika**
    * Az alapgondolat olyan szabályok megadása, amelyek azt mutatják, hogy a
    szabály második részében (a vonal alatt) megejelölt levezetés akkor létezik,
    ...
    * **Szekventkalkulus**
      ...
      * Szekventkalkulus szabályrendszere
        * Gentzen-féle (G-kalkulus) szabályai:
          * Axiómséma: $X \rightarrow X$
          * Levezetési szabályok:
          $$
            (\rightarrow xxx )\quad \frac{\Gamma \rightarrow \Delta, X, X}{\Gamma \rightarrow \Delta, X}\qquad ( xxx \rightarrow)\quad \frac{X, X, \Gamma \rightarrow \Delta}{X, \Gamma \rightarrow \Delta}
          $$
          $$
