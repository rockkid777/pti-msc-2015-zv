...
### Szemantikai következményfogalom
  ...
  * $\mathcal{F}$-nek következménye $\mathcal{G}$ akkor és csak akkor, ha az $\mathcal{F} \lor \neg \mathcal{G}$
      ...
      * Szekventkalkulus szabályrendszere
        * Gentzen-féle (G-)kalkulus szabályai:
          ...
          * Levezetési szabályok:
          ...
          $$
          $$
            (\righarrow \lor)\quad \frac{\Gamma \rightarrow \Delta, X}{\Gamma \rightarrow \Delta, (X \lor Y)}\qquad \frac{\Gamma \rightarrow \Delta, Y}{\Gamma \rightarrow \Delta, (X \lor Y)}\qquad (\lor \rightarrow)\frac{X, \Gamma \rightarrow \Delta\quad Y, \Gamma \rightarrow \Delta}{(X \lor Y), \Gamma \rightarrow \Delta}
          $$
          $$
