...
* Bináris rezolvens  
  Ha $C_1, C_2$ változóidegen elsőrendű klózok magjai és alakjuk $C_1 = C'_1 \lor L_1, C_2 = C'_2 \lor L_2$, ahol $L_1$ és $L_2$ ellentétesen negált literálok, és alapjaik illeszthetők egy $\sigma$ legáltalánosabb illesztő helyettesítéssel, akkor a $C_1, C_2$ klózok bináris rezolvense $C'_1\sigma \lor C'_2\sigma$ magú elsorendű klóz. $C1, C2$ klózok a szülő klózok.
...
* Analitikus tabló  
  ...
  B) Ha van még nem „feldolgozott” $\beta$-formula a gyökérbol a $D$ csúcsba vezeto úton, akkor $D$-ben elágazik a tabló, és a bal oldali rákövetkező csúcsba $\beta$ közvetlen tablójából $\beta_1$, a jobb oldali rákövetkezőbe pedig $\beta_2$ kerül.
