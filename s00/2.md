...
2. $\forall f_{A_i}$ és $\forall (A_{s_{i_1}}, A_{s_{i_2}}, ..., A_{s_{i_k}})$ esetén:
...
Szignatúra algebra homomorfizmus kiterjesztése a $SPEC = (\sum, E)$ specifikációban lévő műveleti
