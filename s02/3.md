...
* TreeSet: a NavigableSet interface-t implementálja piros-fekete fa megvalósításával.
...
* TreeMap: a NavigableMap interface-t implementálja piros-fekete fa megvalósításával.

#### Algoritmusok
* sort(List): a _merge sort algoritmussal_ rendezi a megadott listát O(n*log n)-es műveletigénnyel.
* binarySearch(List, Object): bináris kereséssel keresi a megadott objektumot a rendezett listában.
