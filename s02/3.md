...
A szerződésalapú programtervezésben talán a legfontosabb szerepet a metódusok (Eiffelben,
és a továbbiakban _feature_-ök) elő- és utófeltételei kapják. Az Eiffel nyelvben ezeket külön szintaktikus
elemekkel (blokkokkal) lehet kifejezni. Egy feature a követekzőképp néz ki:
```Eiffel

feature {A, B} -- A és B osztályok,
               -- melyek számára látható a feature
...
_
Megjegyzés: Létezik egy **strip** kulcscszó is, mellyel bonyolultabb utófeltételek esetén azt tudjuk meghatározni, hogy
a kizárólag a felsorolt attribútumok változhatnak meg.
_
