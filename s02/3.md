...
2. [A C++ standard template könyvtár.](#chapter02)
    1. [Konténerek és iterátorok](#section01_02)
    2. [Funktorok](#section01_03)
    3. [Algoritmusok](#section01_01)
...
- 5 fő típusa van
    - Input: előrefelé tudunk menni, illetve módosítani
    - Output: előrefelé, de csak olvasni tudunk
    - Forward: előrefelé, írni olvasni
    - Bidirectinal: előre, hátra tudunk menni, illetve írni olvasni
    - Random access: random hozzáférést tesz lehetővé, nem csak egyesével tudunk lépkedni, írni ovlasni tudunk
- `vector`: random access iterátor
- `deque`: random access iterátor
- `list`: Bidirectinal
- asszociatív konténerek: Bidirectinal
- iterátorok invaliddá válhatnka:
...
- C++ 11-től a labdákkal kiválthatók
- `unary_function`, `binary_function`:
    ...
    binary esetén kettő
- ha függvényekre akarjuk használni az adaptereket akkor direkbe ezt nem tudjuk megtenni, mert hiányoznak a `typedef`-ek
...
class Example {
    public static void main(String[] args) throws Exception {
        ...
        Class[] formalArgs = (args.length > 2) ? new Class[] {String.class} : new Class[] {};
        Object o = c.newInstance();
        Method m = c.getMethod(args[1],formalArgs);
        Object[] actualArgs = (args.length > 2) ? new Object[] {args[2]} : new Object[] {};
...
- hivatkozott objektum többször előfordulása esetén csak egyszer lesz elmentve
