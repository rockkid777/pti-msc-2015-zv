...
![Template-ek kiértékelése](img/templates_cpp.png)
...
* A template-eket konkrét típusparaméterekkel, vagy paraméterek nélkül is használhatjuk. Utóbbi akkor hasznos, ha egy már létező template-es osztályhoz vagy függvényhez új definícót szeretnénk adni.  
  ```C++
...
* A típusparamétereknek adhatunk alapértelmezett értéket is:
  ```C++
    ...
    myClass<> myObject;  // alapértelmezett típusok behelyettesítése
