...
* Deklaratív nyelvek családjába tartozik
    + Imperatív nyelvek: **HOGYAN** csinálja meg a feladatot a program, utasítások írása, sokszor memóriát
      is mi kezeljük
...
1. Közel áll, hogy mi a feladat, mi a feladat leírása
...
* *Reverse*: **NEM FORDÍTJA MEG A MEGÉLVŐ LISTÁT!** Másolatot készít, ami meg van fordítva.
...
* Mintha interaktívan programoznánk
